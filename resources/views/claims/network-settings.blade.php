...
@section('content')
    ...
    <ul class="nav nav-pills">
        ...
        <li class="active"><a href="{{route('network.settings')}}">Network Settings</a></li>
    </ul>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input class="form-control" name="background-image" value="{{$account->getNetwork()->background_image_url}}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
